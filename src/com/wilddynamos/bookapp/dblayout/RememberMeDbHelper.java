...
public class RememberMeDbHelper extends SQLiteOpenHelper {
	...
	private static final String SQL_CREATE_ENTRIES =
	   "CREATE TABLE " + RememberMeColumn.TABLE_NAME + " (" +
	    RememberMeColumn._ID + " INTEGER PRIMARY KEY," +
	    RememberMeColumn.COLUMN_NAME_C1 + TEXT_TYPE + COMMA_SEP +
	    RememberMeColumn.COLUMN_NAME_C2 + TEXT_TYPE + " )";

	private static final String SQL_DELETE_ENTRIES =
	    "DROP TABLE IF EXISTS " + RememberMeColumn.TABLE_NAME;
